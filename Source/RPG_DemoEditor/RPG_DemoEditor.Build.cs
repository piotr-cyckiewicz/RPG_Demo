...
public class RPG_DemoEditor : ModuleRules
{
	public RPG_DemoEditor(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		PrivateDependencyModuleNames.AddRange(new string[] { "UnrealEd", "DataValidation", "FunctionalTesting", "PropertyEditor", "Slate", "SlateCore", "ToolWidgets", "BlueprintGraph", "KismetCompiler" });
